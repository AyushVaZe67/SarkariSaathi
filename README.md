...
- **📚 Source Citations**: Shows which schemes were referenced in answers
- **⚡ Fast Response**: Powered by Groq's llama-3.1-8b-instant model
- **🎯 Intelligent Chunking**: Semantic document chunking for better retrieval
